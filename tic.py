...
# This function introduces the rules of the game Tic Tac Toe
    print("Hello! Welcome to Little Star HR Sec School's Tic Tac Toe game!")
    print("\n")
...
# Call Main
main()
winning_id=input("Winner, enter your student ID:")
online=True
try:
    x=cl_pr.AddTokens(winning_id,5,"Winner of tic tac toe")
    print(x)
except:
